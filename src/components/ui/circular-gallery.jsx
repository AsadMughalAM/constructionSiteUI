...
export function CircularGallery({
  ...
  useEffect(() => {
    ...
    const items = gsap.utils.toArray(gallery.querySelectorAll("[data-ring-item]"));
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "bg-[radial-gradient(circle_at_50%_42%,var(--card),var(--background))]",
        className
      )}
      style={{ cursor: "grab" }}>
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 z-20 bg-[radial-gradient(circle_at_50%_45%,transparent_48%,var(--background))]" />
    </div>
  );
}
