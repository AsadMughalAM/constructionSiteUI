...
export default function InteractiveBook({
    ...
    return (
        <div
            ...
            <motion.div
                className={cn("relative preserve-3d")}
                style={{ width, height }}
                initial={{ x: 0 }}
                ...
                <motion.div
                    ...
                    <div
                        ...
                        <div className="absolute bottom-4 left-3 right-3 text-white text-left">
                            <h1
                                className="text-sm font-display uppercase font-bold tracking-wide mb-1 drop-shadow-md leading-tight">{bookTitle}</h1>
                            <p
                                className="text-[8px] font-sans tracking-widest opacity-90 uppercase border-t border-white/30 pt-1 inline-block">{bookAuthor}</p>
                        </div>

                        {/* Spine Highlight */}
                        <div
                            className="absolute left-0 top-0 bottom-0 w-4 bg-gradient-to-r from-white/30 to-transparent opacity-40" />
                    ...
                    <div
                        ...
                        <div
                            className="flex-1 flex flex-col justify-center items-center text-center opacity-80">
                            <h2 className="text-xl font-display uppercase font-bold text-neutral-800 mb-2 tracking-tight">{bookTitle}</h2>
                            <div className="w-8 h-[1px] bg-neutral-300 mb-3" />
                            <p className="text-xs text-neutral-500 uppercase tracking-widest">Capability Statement</p>
                        </div>
                    </div>
                </motion.div>
                ...
                <div
                            ...
                            <motion.div
                                ...
                                <div
                                    ...
                                    <div className="flex-1">
                                        <div
                                            className="text-xs text-neutral-400 text-right mb-4 font-sans tracking-wider">
                                            {page.pageNumber * 2 - 1}
                                        </div>
                                        <div
                                            className="prose prose-neutral prose-sm max-w-none font-sans text-neutral-700 leading-relaxed select-none">
                                            {page.title && (
                                                <h3
                                                    className="text-xl font-medium text-center mb-6 text-neutral-800 tracking-tight">
                                                    {page.title}
                                                </h3>
                                            )}
                                            {page.content}
                                    ...
                                    <div
                                        className="absolute left-0 top-0 bottom-0 w-8 bg-gradient-to-r from-black/5 to-transparent pointer-events-none mix-blend-multiply" />
                                </div>
                                {/* Back Face (Left Side) */}
                                <div
                                    ...
                                    <div
                                        className="absolute right-0 top-0 bottom-0 w-8 bg-gradient-to-l from-black/5 to-transparent pointer-events-none mix-blend-multiply" />

                                    <div className="flex-1 overflow-hidden">
                                        <div
                                            className="text-xs text-neutral-400 text-left mb-4 font-sans tracking-wider">
                                            {page.pageNumber * 2}
                                        </div>
                                        <div
                                            className="prose prose-neutral prose-sm max-w-none font-sans text-neutral-700 leading-relaxed select-none h-full flex flex-col">
                                            {page.backContent ? (
                                                <div className="flex-1">
                                                    {page.backContent}
                                                </div>
                                            ) : (
                                                <div className="w-full h-full flex items-center justify-center opacity-[0.04]">
                                                    <span className="font-display text-8xl font-extrabold text-black">
                                                        {page.pageNumber * 2}
                                                    </span>
                                                </div>
                                            )}
                    ...
                    <div
                        ...
                        <div
                            className="absolute inset-0 p-8 flex flex-col items-center justify-center text-center opacity-40">
                            <p className="font-sans text-neutral-500">End of statement</p>
                            <button
                                onClick={restartBook}
                                ...
                                <ArrowsClockwise size={14} /> Read Again
                            </button>
                        </div>
                    </div>
                </div>
